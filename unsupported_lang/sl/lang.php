...
return [
    ...
    'account' => [
        ...
        'registration_throttled' => 'Registracija je omejena. Poskusite znova pozneje.',
        'account' => 'Račun',
        'account_desc' => 'Obrazec za upravljanje uporabnika.',
        'redirect_to' => 'Preusmeri na',
        'redirect_to_desc' => 'Ime strani, na katero se preusmeri po posodobitvi, prijavi ali registraciji.',
        'code_param' => 'Parameter aktivacijske kode',
        'code_param_desc' => 'URL parameter strani, ki se uporablja za aktivacijsko kodo registracije',
        'force_secure' => 'Vsili varno povezavo',
        'force_secure_desc' => 'Vedno preusmeri URL z HTTPS shemo.',
        'update_requires_password' => 'Potrebno potrdilo gesla pri posodobitvi',
        'update_requires_password_comment' => 'Ob spremembi profila zahteva trenutno geslo uporabnika.',
        'banned' => 'Oprostite, ta uporabnik trenutno ni aktiviran. Prosim, obrnite se na nas za nadaljnjo pomoč.',
        'activation_email_sent' => 'Aktivacijsko e-pošto smo poslali na vaš e-poštni naslov.',
        'invalid_activation_code' => 'Navedena je bila neveljavna aktivacijska koda.',
        'success_activation' => 'Uspešno ste aktivirali svoj račun.',
        'invalid_current_pass' => 'Vneseno trenutno geslo je neveljavno.',
        'success_saved' => 'Nastavitve uspešno shranjene!',
        'invalid_deactivation_pass' => 'Vneseno geslo za deaktiviranje je neveljavno.',
        'success_deactivation' => 'Uspešno ste deaktivirali svoj račun. Žal nas videti, da odhajate!',
        'login_first' => 'Najprej se morate prijaviti!',
        'already_active' => 'Vaš račun je že aktiviran!',
        'invalid_username' => 'Vneseno uporabniško ime ni veljavno.',
        'invalid_email' => 'Vnesen e-poštni naslov ni veljaven.',
        'activation_by_admin' => 'Uspešno ste se registrirali. Vaš račun še ni aktiven in mora biti odobren s strani skrbnika.',
        'no_avatar' => 'Vaš račun nima slike profila za odstranitev.',
        'avatar_removed' => 'Slika profila je bila uspešno odstranjena.',
    ],
    'reset_password' => [
