...
return [
    ...
    'account' => [
        ...
        'registration_throttled' => 'Registratie is beperkt. Probeer het later opnieuw.',
        'account' => 'Account',
        'account_desc' => 'Gebruikersbeheerformulier.',
        'redirect_to' => 'Doorverwijzen naar',
        'redirect_to_desc' => 'Paginanaam om naar door te verwijzen na update, aanmelden of registratie.',
        'code_param' => 'Activeringscodeparameter',
        'code_param_desc' => 'De paginakoppelingsparameter die wordt gebruikt voor de registratieactiveringscode.',
        'force_secure' => 'Forceer HTTPS-protocol',
        'force_secure_desc' => 'Stuur altijd de URL door met het HTTPS-schema.',
        'update_requires_password' => 'Bevestig wachtwoord bij update',
        'update_requires_password_comment' => 'Vraag het huidige wachtwoord van de gebruiker wanneer hun profiel wordt gewijzigd.',
        'banned' => 'Sorry, deze gebruiker is momenteel niet geactiveerd. Neem contact met ons op voor verdere hulp.',
        'activation_email_sent' => 'Een activeringsmail is verzonden naar jouw e-mailadres.',
        'activation_by_admin' => 'Je hebt je succesvol geregistreerd. Jouw account is nog niet actief en moet worden goedgekeurd door een beheerder.',
        'invalid_activation_code' => 'Ongeldige activeringscode opgegeven.',
        'success_activation' => 'Je account is succesvol geactiveerd.',
        'invalid_current_pass' => 'Het wachtwoord dat je hebt ingevoerd is ongeldig.',
        'success_saved' => 'Instellingen succesvol opgeslagen!',
        'invalid_deactivation_pass' => 'Het wachtwoord dat je hebt ingevoerd is ongeldig.',
        'success_deactivation' => 'Je account is succesvol gedeactiveerd. Jammer dat je weggaat!',
        'login_first' => 'Je moet eerst inloggen!',
        'already_active' => 'Je account is al geactiveerd!',
