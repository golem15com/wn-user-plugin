...
return [
    ...
    'account' => [
        'registration_disabled' => 'A regisztráció jelenleg letiltva van!',
        'registration_throttled' => 'A regisztráció le van lassítva. Kérjük próbálkozzon később!',
        'account' => 'Fiók',
        'account_desc' => 'Felhasználói fiók kezelése űrlap.',
        'redirect_to' => 'Átirányítás ide',
        'redirect_to_desc' => 'Oldal neve, ahova át kell irányítani a frissítés, belépés vagy regisztráció után.',
        'code_param' => 'Aktiválási kód paraméter',
        'code_param_desc' => 'Az aktiválási kódhoz használt oldal URL paraméter.',
        'force_secure' => 'Biztonságos protokollra kényszerítés',
        'force_secure_desc' => 'Mindig az URL-t átirányítani a HTTPS séma használatával.',
        'update_requires_password' => 'Jelszó megerősítése frissítéskor',
        'update_requires_password_comment' => 'Kérje a felhasználó jelenlegi jelszavát a profiljuk módosításakor.',
        'banned' => 'Sajnáljuk, ez a felhasználó jelenleg nem aktiválva. Kérjük, lépjen kapcsolatba velünk további segítségért.',
        'activation_email_sent' => 'Egy aktiváló e-mailt küldtek az e-mail címére.',
        'activation_by_admin' => 'Sikeresen regisztrált. A fiókja még nem aktív, és jóvá kell hagynia egy rendszergazdának.',
        'invalid_activation_code' => 'Érvénytelen aktiválási kódot adott meg.',
        'success_activation' => 'Sikeresen aktiválták a fiókját.',
        'invalid_current_pass' => 'Az Ön által megadott jelenlegi jelszó érvénytelen.',
        'success_saved' => 'A beállítások sikeresen mentve!',
        'invalid_deactivation_pass' => 'Az általad beírt jelszó érvénytelen volt.',
        'success_deactivation' => 'Sikeresen inaktiválták a fiókját. Szomorúan látjuk, hogy távozik!',
        'login_first' => 'Először be kell jelentkeznie!',
        'invalid_username' => 'A megadott felhasználónév érvénytelen.',
        'invalid_email' => 'A megadott email cím érvénytelen.',
        'no_avatar' => 'A fiókodnak nincs képe, amit eltávolíthatsz.',
        'avatar_removed' => 'A profilképed sikeresen el lett távolítva.',
        'already_active' => 'A fiókod már aktiválva van.',
    ],
    'reset_password' => [
        'reset_password' => 'Új jelszó megadása',
