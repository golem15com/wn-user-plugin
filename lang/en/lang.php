...
return [
    ...
    'settings' => [
        ...
        'reset_url_comment' => 'Frontend/SPA URL the password-reset email links to. Leave empty to use the built-in "/reset-password" link. Use a ":code" (or "{code}") placeholder, e.g. https://www.wavepath.org/reset-password?code=:code',
