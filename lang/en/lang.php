...
return [
    ...
    'settings' => [
        ...
        'activation_url_comment' => 'Frontend/SPA URL the activation email links to. Leave empty to use the built-in backend link. Use a ":code" (or "{code}") placeholder, e.g. https://www.example.com/user/activate/:code',
        'reset_url' => 'Headless password-reset URL',
        'reset_url_comment' => 'Frontend/SPA URL the password-reset email links to. Leave empty to use the built-in "/reset-password" link. Use a ":code" (or "{code}") placeholder, e.g. https://www.example.com/reset-password?code=:code',
        ...
        'two_factor_mode_comment' => 'Configure whether two-factor authentication is available for users.',
        'two_factor_mode_disabled' => 'Disabled',
        'two_factor_mode_disabled_comment' => 'Two-factor authentication is not available.',
        'two_factor_mode_optional' => 'Optional',
        'two_factor_mode_optional_comment' => 'Users can choose to enable two-factor authentication.',
        'two_factor_mode_enforced' => 'Enforced',
        'two_factor_mode_enforced_comment' => 'Users are required to enable two-factor authentication.',
        'two_factor_available_methods' => 'Available Methods',
        'two_factor_available_methods_comment' => 'Select which two-factor authentication methods are available to users.',
        'two_factor_method_totp' => 'Authenticator App (TOTP)',
        'two_factor_method_webauthn' => 'Security Keys (WebAuthn)',
        'two_factor_method_email' => 'Email Verification',
        'two_factor_email_code_ttl' => 'Email Code Lifetime (minutes)',
        'two_factor_email_code_ttl_comment' => 'How long an email verification code remains valid.',
        'two_factor_challenge_ttl' => 'Challenge Lifetime (minutes)',
        'two_factor_challenge_ttl_comment' => 'How long a two-factor challenge session remains valid.',
        'two_factor_tab' => 'Two-Factor Auth',
        'two_factor_enforce_groups' => 'Enforce for Groups',
        'two_factor_enforce_groups_comment' => 'When enforced, limit requirement to these groups. Leave empty to enforce for all users.',
        'two_factor_passwordless_login' => 'Passwordless Security Key Login',
        'two_factor_passwordless_login_comment' => 'Allow users to sign in with a security key or passkey without entering a password. Keys must be registered from the account page first.',
        'trusted_device_enabled' => 'Trust this Device',
        'trusted_device_enabled_comment' => 'Allow users to skip 2FA on trusted devices for a configurable period.',
        'trusted_device_ttl_days' => 'Trust Duration (days)',
        'trusted_device_ttl_days_comment' => 'Number of days a device remains trusted before requiring 2FA again.',
        'social_tab' => 'Social Providers',
        'social_overview_hint_label' => 'Social Login Credentials',
        'social_overview_hint' => 'Credentials entered here take priority over the equivalent .env variables. Leave both Client ID and Client Secret blank for a provider to keep using its current .env configuration.',
